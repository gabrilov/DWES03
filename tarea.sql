...
CREATE DATABASE IF NOT EXISTS `tarea3` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `tarea3`;
...
CREATE TABLE `log` (
  ...
  `id_producto` varchar(12) COLLATE utf8_spanish_ci NOT NULL,
  `f_cambio` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

INSERT INTO `log` (`numero`, `id_producto`, `f_cambio`) VALUES
(1, '4', '2019-10-14'),
(2, '6', '2020-07-12'),
(3, '1', '2020-09-11'),
(4, '14', '2021-03-08'),
...
CREATE TABLE `tiendas` (
  ...
  `tlf` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('admin', 'df733656293a19c54f69093ba916f0a1a2a3c151fc95c13f3a794c2631eeb3a6'),
('gestor', 'd74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1');
